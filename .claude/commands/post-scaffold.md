...
- Use the title as the filename using kebab-case.
...
Infer the most likely values for the frontmatter based on the title and use the current date for the pubDate.
