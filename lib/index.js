...
const parseDoc = () => {
    ...
    posts.forEach((post) => {
        ...
        const tmpl = template_processor_1.loadTemplate(grayMatter.data.template);
        let processed = template_processor_1.setMetadata(grayMatter.data, tmpl);
        let markdown = marked_1.default(grayMatter.content);
        processed = template_processor_1.addMain(markdown, processed);
