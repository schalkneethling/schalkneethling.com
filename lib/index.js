...
const parseDoc = () => {
    ...
    posts.forEach((post) => {
        ...
        const fileContents = fs_extra_1.default.readFileSync(post.path, "utf8");
        ...
        processed = (0, template_processor_1.sassToCSS)(processed);
        let postHTML = (0, marked_1.default)(grayMatter.content);
        processed = (0, template_processor_1.setMain)(postHTML, processed);
        fs_extra_1.default.outputFileSync(`${OUTPUT_DIR}/${post.fileName}/index.html`, processed, "utf8");
    });
};
parseDoc();
