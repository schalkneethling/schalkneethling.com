---
title: "Building a Profile Page with HTML and CSS: Planning"
pubDate: 2025-01-03
...
2. A `lang` attribute on the `html` element that correctly reflects the primary language of the page.
3. We will need the following in our `head`:
...
4. The `body` element.
5. Our favicon details
6. Configure our social media sharing details.
...
<Video
  videoSrc="/profile-tutorial/create-issue-from-task-github.mp4"
  width="653"
/>
...
<Video
  videoSrc="/profile-tutorial/edit-issue-description-github.mp4"
  width="653"
/>
